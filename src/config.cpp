...
void LoadConfig(HMODULE hModule) {
    ...
    g_config.osd_enabled             = ReadINIBool(S, "osd_enabled", true, P);
    ...
    g_config.osd_show_frametime      = ReadINIBool(S, "osd_show_frametime", true, P);
    g_config.osd_show_frametime_graph = ReadINIBool(S, "osd_show_frametime_graph", false, P);
    g_config.osd_show_pipeline       = ReadINIBool(S, "osd_show_pipeline", true, P);
    g_config.osd_show_fg             = ReadINIBool(S, "osd_show_fg", true, P);
    g_config.osd_show_limiter        = ReadINIBool(S, "osd_show_limiter", true, P);
    g_config.osd_show_pqi            = ReadINIBool(S, "osd_show_pqi", true, P);
    g_config.osd_show_cpu_latency    = ReadINIBool(S, "osd_show_cpu_latency", true, P);
    g_config.osd_show_pqi_breakdown  = ReadINIBool(S, "osd_show_pqi_breakdown", true, P);
    g_config.osd_show_1pct_low       = ReadINIBool(S, "osd_show_1pct_low", true, P);
    g_config.osd_show_smoothness     = ReadINIBool(S, "osd_show_smoothness", true, P);
    g_config.osd_show_gsync_status   = ReadINIBool(S, "osd_show_gsync_status", true, P);
